...
try:
    ...
    print("LaSOTDataset: LLaVA模块可用")
except ImportError as e:
    LLAVA_AVAILABLE = False
    print(f"LaSOTDataset: LLaVA模块不可用: {e}")
...
class LaSOTDataset(BaseDataset):
    ...
    def _construct_sequence(self, sequence_name):
        ...
        language_file_llava = os.path.join(self.base_path, class_name, sequence_name, "nlp_模板+图像.txt")
        ...
        if os.path.exists(language_file_llava):
            ...
            try:
                ...
                if os.path.exists(first_frame_path):
                    print(f"\n[LaSOTDataset] 处理序列: {sequence_name}")
                    ...
                    if w > 0 and h > 0:
                        ...
                        if x2 > x1 and y2 > y1:
                            ...
                            # 保存语言描述到文件（在原始路径保存为nlp_llava.txt）
                            ...
                            language = self._get_original_language(original_language_file, target_class)
                    else:
    ...
    def _get_original_language(self, language_file_path, target_class):
        """获取原始的语言描述"""
