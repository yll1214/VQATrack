...
def main():
    ...
    parser.add_argument('--tracker_name', default="LiteTrack", type=str, help='Name of tracking method.')
    parser.add_argument('--tracker_param', default="baseline_base", type=str, help='Name of config file.')
    parser.add_argument('--runid', type=int, default=None, help='The run id.')
    parser.add_argument('--dataset_name', type=str, default='otb', help='Name of dataset (otb99, nfs, uav, tpl, vot, tnl2k, got10k, gotv, lasot).')
    parser.add_argument('--sequence', type=str, default=None, help='Sequence number or name.')
    parser.add_argument('--debug', type=int, default=1, help='Debug level.')
    parser.add_argument('--threads', type=int, default=0, help='Number of threads.')
    parser.add_argument('--num_gpus', type=int, default=0)

    parser.add_argument('--params__model', type=str, default="/root/autodl-tmp/uvl2/pretrain/baseline_base/LiteTrack_ep0300.pth.tar", help="Tracking model path.")
