...
from lib.models.backbones.modality_unified_feature_extractor import ModalityUnifiedFeatureExtractor
...
class BaseTrainer:
                ...
                for epoch in range(self.epoch+1, max_epochs+1):
                    ...
                    if epoch == 50:
                        for param_group in self.optimizer.param_groups:
                            param_group['lr'] *= 0.5  
                        print(f"Epoch {epoch}: 学习率减半至{self.optimizer.param_groups[0]['lr']}")
                    self.train_epoch()
    ...
    def load_checkpoint(self, checkpoint=300, fields=None, ignore_fields=None, load_constructor=False):
