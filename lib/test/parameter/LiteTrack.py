...
def parameters(yaml_name: str, extra_cfg=None, epoch=None):
    ...
    yaml_file = os.path.join(prj_dir, 'experiments/LiteTrack/%s.yaml' % yaml_name)
    ...
    params.checkpoint = os.path.join(save_dir, "checkpoints/LiteTrack_ep0300.pth.tar")  
    #params.checkpoint = os.path.join(save_dir, "checkpoints/UVLTrack_ep0300.pth.tar")  # 470
