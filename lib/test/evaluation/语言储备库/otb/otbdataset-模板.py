...
class OTBDataset(BaseDataset):
    ...
    def __init__(self):
        ...
        # 确保语言描述目录存在
        self.language_dir = os.path.join(self.base_path, 'llava_模板')
    ...
    def _construct_sequence(self, sequence_info):
        ...
        elif LLAVA_AVAILABLE and os.path.exists(first_frame_path):
            try:
                ...
                if x2 > x1 and y2 > y1:
                    ...
                    # 3. 使用LLaVA分析目标图像
                    print(f"[OTBDataset] 使用LLaVA分析目标...")
                    ...
                    print(f"[OTBDataset] 边界框无效，使用原始描述")
